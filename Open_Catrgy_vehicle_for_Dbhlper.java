...
public class Open_Catrgy_vehicle_for_Dbhlper extends SQLiteOpenHelper {

   private static final String DATABASE_NAME = "Open_vehicle.db";
   private static final String TABLE_NAME ="open_vehicle";
   ...
   public Open_Catrgy_vehicle_for_Dbhlper(Context context)
   {
   ...
   public boolean insert_categry_vehicle  (String latitute, String longitute,String description)
   {

...
public class Cls_Catrgy_Dbhlper extends SQLiteOpenHelper {

   private static final String DATABASE_NAME = "Cls_vehicle.db";
   ...
   public Cls_Catrgy_Dbhlper(Context context)
   {

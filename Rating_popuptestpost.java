...
// this contains better solution then Rating_popup because of post method send data

public class Rating_popuptestpost extends AppCompatActivity implements View.OnClickListener{
...
*/
...

    {
        ...
        switch(view.getId())
        {
                ...
                if (cancel) {
                    ...
                    if (stars_mavyn > 0 & stars_driver > 0) {
                        ...
                        if (hit.getResult() == 1) {
                            ...
                            Toast.makeText(Rating_popuptestpost.this, "submitted", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Rating_popuptestpost.this, "not submitted", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Rating_popuptestpost.this, "Rating missing", Toast.LENGTH_SHORT).show();
                }
            ...
            case R.id.no_thank:
                ...
                Rating_popuptestpost.this.finish();
   ...
   private class Hitdata implements Runnable
    {
        ...
        public void run() {
            try
            {
               ...
               // DataInputStream input;
                URL url = new URL("http://192.168.0.131/mavyn/online/customerapp.php");
               ...
               /* if (responseCode == HttpsURLConnection.HTTP_OK) {
                ...
                BufferedReader readdata=new BufferedReader(new InputStreamReader(urlConn.getInputStream()));

                String ss=readdata.readLine();

                Toast.makeText(Rating_popuptestpost.this,ss,Toast.LENGTH_SHORT).show();

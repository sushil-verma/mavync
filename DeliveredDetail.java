...
public class DeliveredDetail extends AppCompatActivity {
	...
	private class GrabURL extends AsyncTask<String, Void, String> 
    {
    	  ...
    	  private ProgressDialog dialog = new ProgressDialog(DeliveredDetail.this);
    	...
    	return local; 
    	  ...
    	  protected void onPostExecute(String content) 
    	  {
    	   ...
    	   Toast toast;
    	     if (error) 
    	      {
    	      toast = Toast.makeText(DeliveredDetail.this,content, Toast.LENGTH_LONG);
    	      toast.setGravity(Gravity.TOP, 25, 400);
    	      toast.show();

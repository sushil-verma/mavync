...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public CategoryAdapter(ArrayList<Vehicle_category> myDataset, Context context) {
        mDataset = myDataset;
            ...
            switch (vehicle_type_id)
            {
                case 44:
                    ...
                    if (mDataset.get(position).isSelected()) {
                        holder.image.setImageResource(R.drawable.id044);
                    } else {
                        holder.image.setImageResource(R.drawable.id44);
                    }
                    break;
                case 9:
                    holder.vehicle_weight.setText(data.getWeight_of_truck());
                    holder.vehicle_tyre_no.setText(data.getNo_of_tyre());
                    if (mDataset.get(position).isSelected()) {
                        holder.image.setImageResource(R.drawable.id09);
                    } else {
                        holder.image.setImageResource(R.drawable.id9);
                    }
                    break;
                ...
                case 18:
                    ...
                    holder.vehicle_tyre_no.setText(data.getNo_of_tyre());
                    if (mDataset.get(position).isSelected()) {
                        holder.image.setImageResource(R.drawable.id018);
                    } else {
                        holder.image.setImageResource(R.drawable.id18);
                    }
                    break;
                ...
                case 91:
                    ...
                    holder.vehicle_tyre_no.setText(data.getNo_of_tyre());
                    if (mDataset.get(position).isSelected()) {
                        holder.image.setImageResource(R.drawable.id091);
                    } else {
                        holder.image.setImageResource(R.drawable.id91);
                    }
                    break;
...
*//*
        ...
        if (mDataset.get(position).isSelected()) {
            holder.image.setImageResource(R.drawable.selected_vehicleopen);
        } else {
            holder.image.setImageResource(R.drawable.roundtruckopen);
        }*/
